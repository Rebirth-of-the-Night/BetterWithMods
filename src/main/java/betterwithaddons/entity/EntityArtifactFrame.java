...
public class EntityArtifactFrame extends EntityItemFrame implements IEntityAdditionalSpawnData {
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        this.updateFacingWithBoundingBox(EnumFacing.byHorizontalIndex(compound.getByte(TAG_FACINGDIRECTION)));
    ...
    public void readSpawnData(ByteBuf additionalData) {
        updateFacingWithBoundingBox(EnumFacing.byHorizontalIndex(additionalData.readShort()));
    }
