    ...
    public Vec3d getFlowVector(IBlockAccess world, BlockPos pos) {
        ...
        for (EnumFacing enumfacing : EnumFacing.HORIZONTALS)
        {
            ...
            if (otherlevel >= 0)
            {
                ...
                flowx += (double)(enumfacing.getXOffset() * l);
                flowy += (double)(enumfacing.getYOffset() * l);
                flowz += (double)(enumfacing.getZOffset() * l);
        ...
        if(flowDir.getAxis().isHorizontal())
        {
            ...
            flowx += left.getXOffset() * leftDist + right.getXOffset() * rightDist;
            flowz += left.getZOffset() * leftDist + right.getZOffset() * rightDist;
        }
